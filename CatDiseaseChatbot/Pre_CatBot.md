...
![양식 입력 기반 질병 예측](CatDiseaseChatbot/catbotrun/고양이질병예측(양식기반)실행전버전.png)

- 실행후

![양식 입력 기반 질병 예측](CatDiseaseChatbot/catbotrun/고양이질병예측(양식기반)실행버전.png)
...
![자유형 챗봇](CatDiseaseChatbot/catbotrun/고양이질병자가진단(자유형)실행전번전.png)
